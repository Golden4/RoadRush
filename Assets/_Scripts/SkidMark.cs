...
public class SkidMark : MonoBehaviour {
	...
	// Max number of marks total for everyone together
	const float MARK_WIDTH = 0.2f;
	// Width of the skidmarks. Should match the width of the wheels
	const float GROUND_OFFSET = 0.02f;
	// Distance above surface in metres
	const float MIN_DISTANCE = 1.0f;
	// Distance between points in metres. Bigger = more clunky, straight-line skidmarks
